...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.html"><img src="img/logo.png" height="30" width="100"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="nav-item"><a class="nav-link" href="talk.html">Talk</a></li>
...
<!----------------------------------------------------------------------LOGIN MODAL END---------------------------------------------------------->
    ...
    <div id="desc_whole">
            <div class="col-lg-6 col-md-6 col-sm-6" id="desc">
                <p id="sign_up">Create your Account</p>
                <form method="POST" name="registration" action="backend/register.php" onsubmit="return formValidation();">
                    <div class="form-group">
                        <div id="line_one">
                    ...
                    <input class="btn" type="submit" id="create" value="Create" href="#" >
                </form>
                
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6" id="illustration_one">
                <img src="img/Group%203362.svg" class="img-responsive" height="250" width="600">
            </div>
    </div>
